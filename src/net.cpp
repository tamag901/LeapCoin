...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Leapcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"leapcointools.com", "dnsseed.leapcointools.com"},
    {"leapcoinpool.org", "dnsseed.leapcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"leapcointools.com", "testnet-seed.leapcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Leapcoin is probably already running."), addrBind.ToString().c_str());
        else
